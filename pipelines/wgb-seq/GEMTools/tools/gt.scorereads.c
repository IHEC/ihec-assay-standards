...
sr_param param = {
  ...
  .map_score_attr.non_pair_penalty=GT_MAP_SCORE_NON_PAIR_PENALTY,
...
gt_output_sam_attributes *gt_scorereads_setup_sam_tags(gt_sam_headers *sam_headers,sr_param *param)
{
  ...
  output_sam_attributes->output_seq_qual_for_secondary_align=param->output_seq_qual_for_secondary_align;
...
gt_status parse_arguments(int argc,char** argv) {
  ...
  while (true) {
    ...
    case 'c':
      ...
      break;
    case 700:
      param.output_seq_qual_for_secondary_align = true;
      break;
      /* Misc */
    case 'v':
      param.verbose = true;
